...
namespace MVC_CORE.Controllers
{
    ...
    {
        private static string id;//memorare id de confirmare/modificare
        static Model_clienti model = new Model_clienti();//returnare parametri confform codului
        static Confirmare c1 = new Confirmare();//model de confirmare dupa rezervare
