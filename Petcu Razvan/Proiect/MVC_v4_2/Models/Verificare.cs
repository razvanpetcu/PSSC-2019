...
namespace MVC_CORE.Models
{
    public class Verificare
    {
        ...
        private static bool Verificare_nume(string nume)
        {
            if (nume == null)
            {
                return true;
        ...
        private static bool Verificare_prenume(string prenume)
        {
            if (prenume == null)
            {
                return true;
        ...
        private static bool Verificare_camera(Tip_camera t, DateTime check_in, DateTime check_out)
        {
            MySqlConnection conn = new MySqlConnection(ConnectionString);
            string query = "select " + t.ToString() + " from Camere;";
            MySqlCommand cmd = new MySqlCommand(query, conn);
        ...
        private static bool Verificare_date_valabile(DateTime check_in,DateTime check_out, Tip_camera t)
        {
        ...
        private static bool Verificare_carte_credit(Carte_de_credit c,string numar_carte,string data_exp,string ccv)
        {
            return false;
        }
